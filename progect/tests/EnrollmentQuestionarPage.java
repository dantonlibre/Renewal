...
public class EnrollmentQuestionarPage {
...
//
//	/**
//	 * --------- BEGINNING OF COVIDcode ENROLLMENT QUESTIONNAIRE CONTACT INFO
//	 * SECTION ---------
//	 */
//	
//	/**
//	 * COVIDcode Enrollment Questionnaire Contact info: Are you filling this out for
//	 * someone else?
//	 */
//	@FindBy(xpath = "//*[@id=\"proxy_required\"]/div[2]/label")
//	public WebElement enrolmentQuestionareFilingOutForSomeOneElseSign;
//	
//	/**
//	 * COVIDcode Enrollment Questionnaire Contact info:
//	 * Are you filling this out for someone else? drop down
//	 */
//	@FindBy(xpath = "//div[@id='s2id_sp_formfield_proxy_required']")
//	public WebElement enrolmentQuestionareFilingOutForSomeOneElseDropDown;
//	
//	/**
//	 *  COVIDcode Enrollment Questionnaire Contact info:
//	 * Are you filling this out for someone else? Yes button 
//	 */
//	 @FindBy( className =  "select2-result-label")
//	 public List<WebElement> enrolmentQuestionareFilingOutForSomeOneElseYesButton;
//	
//	/**
...
//
//	/**
//	 * COVIDcode Enrollment Questionnaire Demographics: Date form completed Selected
...
//
//	/**
//	 * COVIDcode Enrollment Questionnaire Demographics: DOB calendar Selected date
...
//
//	/**
//	 * COVIDcode Enrollment Questionnaire Demographics: describe your race search
//	 * box
//	 */
...
//	@FindBy(id  = "s2id_autogen8_search")////input[@autocomplete='sp_formfield_sex']
...
//
//	/**
//	 * COVIDcode Enrollment Questionnaire Demographics: error message when enter
//	 * invalid value for inches
//	 */
...
//
//	/**
//	 * COVIDcode Enrollment Questionnaire Symptomology: Were you symptomatic text
//	 */
//	@FindBy(xpath = "//div[@id='symptomatic']/div/label")
//	public WebElement enrollmentQuestionnaireWereYouSymptomaticText;
//
//	/**
//	 * COVIDcode Enrollment Questionnaire Symptomology: Were you symptomatic search
//	 * box
//	 */
...
//
//	/**
//	 * COVIDcode Enrollment Questionnaire Symptomology: What type of test did the
//	 * patient receive search box
//	 */
...
//	/**
//	 * COVIDcode Enrollment Questionnaire Symptomology: When did you first develop
//	 * symptoms of COVID-19 Selected date cannot be in the future text
//	 */
...
//
//	/**
//	 * COVIDcode Enrollment Questionnaire Symptomology: Have you officially been
//	 * diagnosed with COVID-19 dropdown
//	 */
...
//	/**
//	 * COVIDcode Enrollment Questionnaire Symptomology: Have you officially been
//	 * diagnosed with COVID-19 Search Text
//	 */
...
//	/**
//	 * COVIDcode Enrollment Questionnaire Symptomology: When were you officially
//	 * diagnosed with COVID-19 Selected date cannot be in the future text
//	 */
...
//
//	/**
//	 * --------------- BEGINNING OF COVIDcode ENROLLMENT QUESTIONNAIRE EXPOSURES AND
...
//
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Please tell me if you/the
//	 * patient have any of the following medical conditions search box
//	 */
...
//
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Have you/the patient ever
//	 * regularly vaped an e-cigarette or similar device? drop down
//	 */
...
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Have you/the patient ever
//	 * regularly vaped an e-cigarette or similar device? search box
//	 */
...
//
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Have you/the patient
...
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Have you/the patient
//	 * smoked at least 100 cigarettes in your entire life? search box
//	 */
...
//
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors When you smoke/have
...
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors When you smoke/have
//	 * smoked, how many cigarettes do/did you usually smoke daily? search box
//	 */
...
//
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Non-steroidal
//	 * anti-inflammatory drugs (ex. ibuprofen: Advil, Motrin, etc.) drop down
//	 */
...
//
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors How many times have you
//	 * been exposed to someone who tested positive for COVID-19 drop down
//	 */
...
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors How many times have you
//	 * been exposed to someone who tested positive for COVID-19 search box
//	 */
...
//
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Did you/the patient wear
//	 * a mask? drop down
//	 */
...
//
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Myocardial infarction or
//	 * stroke medication (ex. digoxin) drop down
//	 */
...
//
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Paracetamol/acetaminophen
//	 * (ex. acetaminophen: Tylenol) drop down
//	 */
...
//
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Blood thinners (ex.
...
//
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Asthma medication (ex.
...
//
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors ACE-inhibitors for blood
//	 * pressure (ex. enalapril, lisinopril) drop down
//	 */
...
//
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Pollen allergy medication
//	 * (ex diphenhydramine – Benadryl, ioratadine - Claritin) drop down
//	 */
...
//
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors ARBs(Angiotensin II
...
//
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Antibiotics penicillin,
//	 * azithromycin (ex. Z-pack) drop down
//	 */
...
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Non-steroidal
//	 * anti-inflammatory drugs (ex. ibuprofen: Advil, Motrin, etc.) Search Drop Down
//	 * Text Field
//	 */
...
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Myocardial infarction or
//	 * stroke medication (ex. digoxin) Search Drop Down Text Field
//	 */
...
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Paracetamol/acetaminophen
//	 * (ex. acetaminophen: Tylenol) Search Drop Down Text Field
//	 */
...
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Blood thinners (ex.
//	 * warfarin – Coumadin, rivaroxaban – Xarelto) Search Drop Down Text Field
//	 */
...
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Asthma medication (ex.
//	 * albuterol – Ventolin) Search Drop Down Text Field
//	 */
...
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors ACE-inhibitors for blood
//	 * pressure (ex. enalapril, lisinopril) Search Drop Down Text Field
//	 */
...
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Pollen allergy medication
//	 * (ex diphenhydramine – Benadryl, ioratadine - Claritin) Search Drop Down Text
//	 * Field
//	 */
...
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors ARBs(Angiotensin II
//	 * Receptor Blockers) (candesartan- Atacand, valsartan-Diovan) Search Drop Down
//	 * Text Field
//	 */
...
//	/**
//	 * Enrollment Questionnaire Exposures and Risk Factors Antibiotics penicillin,
//	 * azithromycin (ex. Z-pack) Search Drop Down Text Field
//	 */
...
//
//	/**
//	 * --------------- END OF COVIDcode ENROLLMENT QUESTIONNAIRE EXPOSURES AND RISK
//	 * FACTORS SECTION TABLE ---------------
//	 */
//
//	/**
//	 * --------------- BEGINNING OF COVIDcode ENROLLMENT QUESTIONNAIRE VACCINE
//	 * SECTION TABLE ---------------
//	 */
//
...
//
//	/**
//	 * Enrollment Questionnaire Vaccine Have you received your first COVID-19
//	 * Vaccine drop down
//	 */
...
//
//	/**
//	 * Enrollment Questionnaire Vaccine Have you received your second COVID-19
//	 * Vaccine drop down
//	 */
...
//
//	/**
//	 * Enrollment Questionnaire Vaccine What date did you receive the second vaccine
//	 * search box
//	 */
...
//
//	/**
//	 * Enrollment Questionnaire Vaccine What date did you receive the first vaccine
//	 * search box
//	 */
...
//
//	/**
//	 * --------------- END OF COVIDcode ENROLLMENT QUESTIONNAIRE VACCINE SECTION
//	 * TABLE ---------------
//	 */
//
//	/**
//	 * --------------- BEGINNING OF COVIDcode ENROLLMENT QUESTIONNAIRE DISEASE
//	 * COURSE SECTION ---------------
//	 */
//
...
//
//	/**
//	 * Enrollment Questionnaire Disease Course: Which organ(s) showed signs of
//	 * dysfunction/failure? text
//	 */
...
//	/**
//	 * Enrollment Questionnaire Disease Course: Which organ(s) showed signs of
//	 * dysfunction/failure drop down values
//	 */
//	@FindBy(xpath = "//div[@class = 'select2-result-label']")
...
//
//	/**
//	 * Enrollment Questionnaire Disease Course Have you been diagnosed with
//	 * pneumonia due to COVID-19 drop down
//	 */
...
//	/**
//	 * Enrollment Questionnaire Disease Course Have you been diagnosed with
//	 * pneumonia due to COVID-19 Search box
//	 */
...
//
//	/**
//	 * Enrollment Questionnaire Disease Course Were you admitted to the hospital to
//	 * treat your COVID drop down
//	 */
...
//
//	/**
//	 * Enrollment Questionnaire Disease Course What date were you admitted to the
//	 * hospital Search box
//	 */
...
//
//	/**
//	 * --------------- END OF COVIDcode ENROLLMENT QUESTIONNAIRE DISEASE COURSE
//	 * SECTION ---------------
//	 */
//
